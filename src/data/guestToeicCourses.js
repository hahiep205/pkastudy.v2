...
const GUEST_TOEIC_COURSE_MAP = {
  "toeic-very-easy": {
    ...
    description: "Từ vựng TOEIC cực kỳ cơ bản dành cho người mới bắt đầu, phù hợp để guest user học ngay mà không cần đăng nhập.",
    language: "en",
    lang: "en",
    sortOrder: 1,
  ...
  "toeic-basic": {
    ...
    description: "Bộ 50 chủ đề từ vựng TOEIC cốt lõi giúp guest user học trực tiếp và vẫn lưu được tiến trình ngay trên thiết bị.",
    language: "en",
    lang: "en",
    sortOrder: 2,
