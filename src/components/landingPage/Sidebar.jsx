        ...
        <aside className={`sidebar ${isOpen ? 'open' : ''}`} id="sidebar">
            ...
            <nav className="sidebar-nav">
                ...
                <NavLink to="/dashboard/courses" className={getSidebarLinkClass} onClick={onClose}>
                    ...
                    <span className="sidebar-label">Chủ đề</span>
                </NavLink>
                ...
                <NavLink to="/dashboard/toeic" className={getSidebarLinkClass} onClick={onClose}>
                    <span className="sidebar-label">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="19" height="19" fill="currentColor">
                    ...
                    <span className="sidebar-label">TOEIC</span>
                </NavLink>
            ...
            <div className="sidebar-bottom">
                ...
                {user?.role === 'admin' && (
                    <NavLink to="/manager" className={getSidebarLinkClass} onClick={onClose}>
                        <span className="sidebar-label">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="19" height="19" fill="currentColor">
                                <path d="M12 2L20 6V12C20 17.55 16.16 22.74 12 24C7.84 22.74 4 17.55 4 12V6L12 2ZM11 14H8L12 18L16 14H13V9H11V14ZM12 4.18L6 7.18V12C6 16.52 8.98 20.69 12 21.82C15.02 20.69 18 16.52 18 12V7.18L12 4.18Z"></path>
                            </svg>
                        </span>
